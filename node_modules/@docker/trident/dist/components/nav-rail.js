...
function NavRail({ items, activeId, onSelect, footer, className }) {
  return /* @__PURE__ */ jsxs(
    "nav",
    {
      className: cn(
        "flex w-12 shrink-0 flex-col items-center gap-1 border-r border-border bg-card py-2",
        className
      ),
      style: { boxShadow: "inset 0 1px 0 var(--highlight)" },
      children: [
        /* @__PURE__ */ jsx("div", { className: "mb-2 flex size-8 items-center justify-center", children: /* @__PURE__ */ jsx(NavRailWhaleIcon, { className: "size-5 text-muted-foreground" }) }),
        items.map((item) => /* @__PURE__ */ jsx(
          "button",
          {
            ...
            className: cn(
              "flex size-8 items-center justify-center rounded-[var(--dds-radius-default)] transition-colors",
              item.id === activeId ? "bg-primary-wash text-primary" : "text-muted-foreground hover:bg-hover-overlay hover:text-foreground"
            ),
...
function NavRailWhaleIcon({ className }) {
  return /* @__PURE__ */ jsx(
    "svg",
    {
      viewBox: "0 0 24 24",
