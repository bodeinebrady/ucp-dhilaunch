...
function TableFooter({className, ...props}: React.ComponentProps<'tfoot'>) {
  return (
    <tfoot
      ...
      className={cn(
        'border-t border-border bg-selected-overlay font-label tracking-label [&>tr]:last:border-b-0',
        className
      )}
      {...props}
    />
...
function TableRow({className, ...props}: React.ComponentProps<'tr'>) {
  return (
    <tr
      data-slot="table-row"
      className={cn(
        'border-b border-border transition-colors ease-default hover:bg-hover-overlay data-[state=selected]:bg-muted',
        className
      )}
      {...props}
    />
...
function TableHead({className, ...props}: React.ComponentProps<'th'>) {
  return (
    <th
      ...
      className={cn(
        'h-10 px-2 text-left align-middle font-label tracking-label whitespace-nowrap text-foreground [&:has([role=checkbox])]:pr-0',
        className
      )}
      {...props}
    />
 ...
 *
 * Defaults to `align-middle` with `whitespace-nowrap` for single-line cells.
 * For multi-line cells (e.g., name + subtitle), add `className="align-top whitespace-normal"`
 * to allow wrapping and top-align all cells in the row with the first line of text.
 *
 * ### Component Props
 *
