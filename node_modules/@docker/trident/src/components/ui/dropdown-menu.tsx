 ...
 * @wcag 2.4.7 Focus Visible — items receive a visible focus highlight via `focus:bg-accent` plus a `focus:ring-1 focus:ring-ring focus:ring-inset` secondary cue so the state meets WCAG 1.4.11 contrast in dark theme.
 */
...
function DropdownMenuItem({
  ...
  return (
    <DropdownMenuPrimitive.Item
      ...
      className={cn(
        "group/dropdown-menu-item relative flex cursor-default items-center gap-2 rounded px-2 py-1.5 text-sm outline-hidden select-none focus:bg-accent focus:text-accent-foreground focus:ring-1 focus:ring-ring focus:ring-inset not-data-[variant=destructive]:focus:**:text-accent-foreground data-inset:pl-8 data-[variant=destructive]:text-tag-destructive-fg data-[variant=destructive]:focus:bg-destructive-subtle data-[variant=destructive]:focus:text-tag-destructive-fg data-disabled:pointer-events-none data-disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4 [&_svg:not([class*='text-'])]:text-muted-foreground data-[variant=destructive]:*:[svg]:text-tag-destructive-fg",
        className
      )}
      {...props}
    />
...
function DropdownMenuLabel({
  ...
  return (
    <DropdownMenuPrimitive.Label
      ...
      data-inset={inset}
      className={cn(
        'px-2 py-1.5 text-xs font-label text-muted-foreground data-inset:pl-8 high-contrast:text-foreground',
        className
      )}
      {...props}
    />
...
function DropdownMenuShortcut({
  ...
  return (
    <span
      ...
      aria-hidden="true"
      className={cn(
        'ml-auto text-xs tracking-widest text-muted-foreground group-focus/dropdown-menu-item:text-accent-foreground high-contrast:text-foreground',
        className
      )}
      {...props}
    />
