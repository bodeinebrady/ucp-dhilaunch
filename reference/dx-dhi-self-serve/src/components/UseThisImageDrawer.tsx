    ...
    <>
      ...
      <div className="flex-1 overflow-y-auto" style={{ padding: '24px' }}>
        <p className="m-0 mb-5" style={{ fontSize: '0.875rem', color: 'var(--muted-foreground)', lineHeight: 1.6 }}>
          Docker Hardened Images are continuously patched, minimal, and compliance-ready. Sign in to start a free trial and mirror images to your registry.
        </p>
      ...
      <DrawerFooter>
        <PrimaryButton>Sign in to start a free trial</PrimaryButton>
      </DrawerFooter>
    </>
  );
}
...
function DrawerPersonal({ onClose }: { onClose: () => void }) {
  return (
    <>
      ...
      <div className="flex-1 overflow-y-auto" style={{ padding: '24px' }}>
        <p className="m-0 mb-5" style={{ fontSize: '0.875rem', color: 'var(--muted-foreground)', lineHeight: 1.6 }}>
          Start a free trial to mirror Docker Hardened Images to your registry. Continuously patched, minimal, and compliance-ready.
        </p>
      ...
      <DrawerFooter>
        <PrimaryButton>Start a free trial</PrimaryButton>
      </DrawerFooter>
    </>
  );
}
...
function DrawerOrgNoEntitlements({ onClose }: { onClose: () => void }) {
  return (
    <>
      ...
      <div className="flex-1 overflow-y-auto" style={{ padding: '24px' }}>
        <p className="m-0 mb-5" style={{ fontSize: '0.875rem', color: 'var(--muted-foreground)', lineHeight: 1.6 }}>
          Start a free trial to mirror Docker Hardened Images to your organization's registry. Continuously patched, minimal, and compliance-ready.
        </p>
